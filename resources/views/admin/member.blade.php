                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="{{ route('admin.addMember') }}" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới nhân viên</a>
                        </div>
                        <div class="col-sm-2">
...
{{--                            <td>#CD12837</td>--}}
                            ...
                            <td class="table-td-center">
                                <a class="btn btn-primary btn-sm edit" title="Sửa" href="{{ route('admin.editMember', $admin) }}">
                                    <i class="fas fa-edit" style="color: rgb(245 157 57);"></i>
                                </a>
                                <form method="post" action="{{ route('admin.destroy', $admin->id) }}" style="display: inline-block;">
                                    @method('DELETE')
                                    @csrf
                                    <button class="btn btn-primary btn-sm trash" title="Xóa" onclick="myFunction(this)">
                                        <i class="fas fa-trash-alt" style="color: #de0400;"></i>
                                    </button>
                                </form>
                            </td>
                        </tr>
...
<script>
    // JavaScript code to hide the success message after a few seconds (optional)
    setTimeout(function() {
        $('.alert-success').fadeOut();
    }, 3500); // The message will disappear after 5 seconds (5000 milliseconds)
</script>
