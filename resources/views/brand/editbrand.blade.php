...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item active"><a href="#"><b>Chinh sửa thương hiệu</b></a></li>
        </ul>
        <div id="clock"></div>
    </div>
    <div class="row">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group  col-md-12">
                              <span class="thong-tin-thanh-toan">
                                <h5>Chỉnh sửa thông tin thương hiệu cơ bản</h5>
                              </span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" name="name" type="text" required value="{{ $brand->name }}" style="width: 465.6px;">
                            </div>
                        </div>
                        <BR>
                        ...
                        <a class="btn btn-cancel" data-dismiss="modal" href="{{ asset('brand.brand') }}">Hủy bỏ</a>
                        <BR>
                        </form>
                    </div>
