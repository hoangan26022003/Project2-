                ...
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="{{ route('brand.addbrand') }}" title="Thêm"><i class="fas fa-plus"></i>
                        ...
                        @foreach($brands as $brand)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary btn-sm edit" type="button" href="{{route('brand.editbrand', $brand)}}" title="Sửa" style="color:rgb(245 157 57);">
