            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                            <a class="btn btn-add btn-sm" href="{{ route('payment.addPayment') }}" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới phương thức thanh toán</a>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        @foreach($paymentMethods as $payment)
                            <tr>
                                ...
                                <td>{{ $payment->name }}</td>
                                <td>
                                    <a class="btn btn-primary btn-sm edit" href="{{ route('payment.editPayment', $payment)}}" title="Sửa">
                                        <i class="fas fa-edit"></i></a>
                                    <form method="post" action="{{ route('payment.destroy', $payment) }}" style="display: inline-block;">
                                        @method('DELETE')
                                        @csrf
...
<script>
    jQuery(document).ready(function ($) {
        $('.trash').click(function (event) {
            ...
            Swal.fire({
                title: "Cảnh báo",
                text: "Bạn có chắc chắn là muốn xóa phương thức thanh toán này?",
                icon: "warning",
