...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item active"><a href="#"><b>Chinh sửa phương thức thanh toán</b></a></li>
        </ul>
        <div id="clock"></div>
    </div>
    <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group  col-md-12">
                              <span class="thong-tin-thanh-toan">
                                <h5>Chỉnh sửa thông tin phương thức thanh toán cơ bản</h5>
                              </span>
                            </div>
                        </div>
                        <form method="POST" action="{{ route('payment.update', $paymentMethod->id) }}">
                            <div class="row" >
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" name="name" type="text" required value="{{ $paymentMethod->name }}" style="width: 1165px;">
                                </div>
                            </div>
