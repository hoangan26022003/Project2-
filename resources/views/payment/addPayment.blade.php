...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title" style="margin-bottom: 20px">Tạo mới phương thức thanh toán</h3>
                <div class="tile-body">
                    <form class="row" method="post" action="{{ route('payment.store') }}">
                        <div class="form-group col-md-12">
                            @csrf
                            <label class="control-label">Nhập tên phương thức thanh toán</label>
                            <input class="form-control" name="name" type="text" required>
                        </div>
                        <button class="btn btn-save" style="margin-left: 15px; margin-right: 15px">Lưu lại</button>
                        <a class="btn btn-cancel" href="{{route('payment.payment')}}">Hủy bỏ</a>
                    </form>
                </div>
            </div>
        </div>
