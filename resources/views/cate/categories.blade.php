                ...
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-add btn-sm" href="{{ asset('cate/addCat') }}" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo mới danh mục</a>
                        </div>
                        <div class="col-sm-2">
...
{{--                            <td>83216006</td>--}}
                            <td>{{ $category->name }}</td>
                            <td>
                                <a class="btn btn-primary btn-sm edit" href="{{ route('cate.editCat', $category)}}" title="Sửa">
                                    <i class="fas fa-edit"></i></a>
                                <form method="post" action="{{ route('cate.destroy', $category->id) }}" style="display: inline-block;">
                                    @method('DELETE')
                                    @csrf
