            ...
            <div class="tile">
                ...
                <div class="tile-body">
                    ...
                    <form class="row" method="post" action="{{ route('cate.store') }}">
                        ...
                        <button type="submit" class="btn btn-save" style="margin-left: 15px; margin-right: 15px">Lưu lại</button>
                        <a class="btn btn-cancel" href="{{ route('cate.categories') }}">Hủy bỏ</a>
                    </form>
                </div>
            </div>
        </div>
