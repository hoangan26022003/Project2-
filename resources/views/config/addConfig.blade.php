...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Thêm cấu hình</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title" style="margin-bottom: 20px">Tạo mới cấu hình</h3>
                <div class="tile-body">
                    <form class="row" method="post" action="{{ route('config.store') }}">
                        @csrf
                        <div class="form-group col-md-12">
                            <label class="control-label">Nhập tên cấu hình</label>
                            <input class="form-control" name="name" type="text">
                        </div>
                        <div class="form-group col-md-12">
                            <label class="control-label">Số lượng của cấu hình</label>
                            <input class="form-control" name="amount" type="number" required>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="control-label">Nhập giá tiền cấu hình</label>
