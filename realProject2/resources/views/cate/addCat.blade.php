...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item">Danh sách danh muc</li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title" style="margin-bottom: 20px">Tạo mới danh mục</h3>
                <div class="tile-body">
                    <form class="row" method="post" action="{{ route('cate.store') }}">
