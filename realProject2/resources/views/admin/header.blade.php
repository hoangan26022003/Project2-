...
<aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('/images/hay.jpg')}}" width="50px"
                                        alt="User Image">
        <div>
            <p class="app-sidebar__user-name"><b>Thành_An</b></p>
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{ Request::is('admin/customer*') ? 'active' : '' }}" href="#"><i class='app-menu__icon bx bx-user-voice'></i><span
