                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="{{ route('product.update', $product->id) }}" class="row">
                            ...
                            <div class="form-group  col-md-6">
                                ...
                                <input class="form-control" name="amount" type="number" required value="{{ $product->amount }}">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" name="mota" id="mota">{{ $product->description }}</textarea>
