                ...
                <div class="tile-body">
                    ...
                    <div class="row" >
                        <div class="col-md-12" style="display: flex;justify-content: space-between;align-items: center; margin-top: 5px; margin-bottom: 5px">
                            ...
                            <h3>Giá tiền: {{ $configuration->price }}</h3>
                        </div>
                        <a class="edit-button" style="color:#FFFFFF; margin-left: 15px; width: 48.5%; text-align: center"><i class="fas fa-edit"></i> Sửa</a>
                        <a class="delete-button" style="color:#FFFFFF; width: 48.5%; text-align: center"><i class="fas fa-trash-alt"></i> Xóa</a>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Configuration List -->
