    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form class="row" method="post" action="{{ route('brand.store') }}">
                        <div class="form-group col-md-12">
                            @csrf
                            <label class="control-label">Nhập tên thương hiệu mới</label>
                            <input class="form-control" name="name" type="text">
                        </div>
                        <button class="btn btn-save" style="margin-right: 15px; margin-left: 15px">Lưu lại</button>
                        <a class="btn btn-cancel" href="{{ asset('brand/brand') }}">Hủy bỏ</a>
                    </form>
                </div>
