    ...
    <div class="block-filter-brands">
        <div class="brands__content">
            <div class="list-brand">
                <a href="#" target="_self" class="list-brand__item button__link">Apple</a>
                <a href="#" target="_self" class="list-brand__item button__link">Samsung</a>
                <a href="#" target="_self" class="list-brand__item button__link">xiaomi</a>
                <a href="#" target="_self" class="list-brand__item button__link">oppo</a>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="single-banner shop-page-banner">
                        <a href="#">
                            <img src="images/bg-banner/mac-banner.png" alt="Li's Static Banner" style="width: 1170px; height: 269px;">
                        </a>
                    </div>
